...
export default function EmailForm({ setEmail }) {
    ...
    return (
        <form
            ...
            className="flex flex-col gap-2 items-center md:items-start text-gray-600 w-full max-w-md m-auto"
        >
            {/* Registro de correo */}
            ...
            <div className="flex flex-col gap-2 w-full justify-around md:max-w-sm">
                <div className="flex items-center gap-2 w-full font-semibold">
                    <input
                        ...
                        id="remember"
                        disabled={loading}
                        className="accent-purple-500 disabled:cursor-not-allowed rounded-md border-purple-500 focus:outline-purple-500 w-6 h-6"
                        {...register("remember")}
                    />
